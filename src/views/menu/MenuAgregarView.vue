...
<div class="contenedor-principal">
  <h1>Creación del Plato</h1>
  <form action="">
      <div class="contenedor"> 
          <div class="izquierda">
              <label for="Nitem">Nombre del plato</label>
              <input type="text" id="Nitem" name="Nitem">
              
              <label for="Citem">Descripcion</label>
          ...
          <div class="derecha">
              ...
              <label for="descripcion">Porciones</label>
              <textarea id="descripcion" name="descripcion"></textarea>
              <label for="descripcion">Sub Categoria</label>
              <textarea id="descripcion" name="descripcion"></textarea>
          </div>
      </div>
      <div class="botones">
